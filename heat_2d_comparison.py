...
#x = [0.08, 64.87, 69996.76]

#PCM original

x = [0.009, 64.87, 69996.76]

T_out, Tvz, Tvz_out, Tvz_left, Tvz_right, f2, Q_sum, Q_sum1 = heat_2d(x)

x = [0.08, 64.87, 69996.76]

T_out_opt, Tvz_opt, Tvz_out_opt, Tvz_left_opt, Tvz_right_opt, f2_opt, Q_sum_opt, Q_sum1_opt = heat_2d(x)


x = [0.005, 0, 0]
c0 = 460
lambd = 40
T_out_lw, Tvz_lw, Tvz_out_lw, Tvz_left_lw, Tvz_right_lw, f2_lw, Q_sum_lw, Q_sum1_lw = heat_2d(x)
...
ax1.plot(np.linspace(10, 14, 240), Tvz_out[0:-1:int(60/dt)], linewidth=3)

ax1.plot(np.linspace(10, 14, 240), Tvz_out_opt[0:-1:int(60/dt)], linewidth=3)
ax1.plot(np.linspace(10, 14, 240), Tvz_out_lw[0:-1:int(60/dt)], linewidth=3)
ax1.plot(np.linspace(10, 14, 240), np.ones(240) * T_set, '--y')


ax1.legend(['Outlet temperature / PCM collector', 'Outlet temperature / optimized PCM collector', 'Outlet temperature / LW collector', 'T_set - Set outlet temperature'], fontsize=24, bbox_to_anchor=(0., 1.02, 1., .102), loc='lower left',
...
ax2.plot(np.linspace(10, 14, 240), rad_val[60 * start_hour: int(60 * end_hour)], 'r--')
...
#
#
# plt.plot(Tvz_out[0:-1:int(60/dt)])
# plt.plot(Tvz_out_opt[0:-1:int(60/dt)])
# plt.plot(Tvz_out_lw[0:-1:int(60/dt)])
#
#
#
#
...
# plt.legend(['Outlet air temperature of PCM collector', 'Outlet air temperature of PCM collector - optimized', 'Outlet air temperature of LW collector', 'T_set - Set outlet air temperature'])
#
# plt.show()
...
# if (True):
#     plt.savefig("ImagesComp/{:02.0f}{}.png".format(f2, 'fitness'), format='png', dpi=300)
#     print('Image ADDED!')
# else:
